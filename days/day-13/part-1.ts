export default async function part1(input: string) {
  ...
  input
    ...
    .forEach((block) => {
      ...
      const prizeX = Number(prizeXString.split("=")[1].replace(",", ""));
      const prizeY = Number(prizeYString.split("=")[1]);
...
// Solve time: 17 minutes and 23 seconds
// Note: I used the explanation from this Reddit post, as I had no idea how to solve this otherwise
